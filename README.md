...
- Ma compréhension du laravel/blade ( je ne comprends pas très bien c'est un peu trop restreint)
- Mon envie de faire du laravel ( je veux pas du tout faire ça plus tard)
- Les commentaires et pièces jointes ( je ne vois pas trop comment les ajoutés et il me manque du temps )
- transfert de propriété (je ne vois pas du tout comment faire)
# Framework PHP
